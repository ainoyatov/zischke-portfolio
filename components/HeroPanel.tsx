...
//     <Link
//       href={href}
//       className="group relative flex h-full min-h-[33.333vh] items-center justify-center overflow-hidden md:min-h-screen transition-all duration-500 ease-out hover:-translate-y-6 hover:scale-[1.02] hover:shadow-2xl"
//       style={{
